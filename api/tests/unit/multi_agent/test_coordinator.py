...
from orion_agent.multi_agent.coordinator import Coordinator
from orion_agent.multi_agent.types import TaskAssignment
...
async def test_worker_failure_isolated(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(
        "orion_agent.multi_agent.coordinator.run_forked_agent",
