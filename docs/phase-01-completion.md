...
- AgentTool 子 agent 全域並發上限 → [`docs/phases/17-agenttool-concurrency-limit.md`](../../docs/phases/17-agenttool-concurrency-limit.md)
- WebFetchTool URL caching → [`docs/phases/18-webfetch-cache.md`](../../docs/phases/18-webfetch-cache.md)
