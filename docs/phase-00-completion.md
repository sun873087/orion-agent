...
**完成日期**:2026-05-07
**Spec doc**:`docs/phases/00-foundation.md`
...
| AgentContext + abort_event(`core/state.py`)| Phase 1 query_loop turn 邊界 abort + BashTool watch_abort 已用;**stream 中途即時 abort** 升級為獨立 phase plan(`docs/phases/plan/16-abort-stream-mid-flight.md`)|
