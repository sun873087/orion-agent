...
model channel。**已完成**:A1 訊息「為什麼這樣回答」追溯(per-turn audit +
content-addressed dedup + DB persistence)。**接下來**:A2 prompt audit /
A3 敏感資訊偵測 / B1 recap chip / B2 semantic search 等。
