    ...
    <div className="min-h-full flex items-center justify-center bg-claude-cream px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-soft p-6 space-y-3">
          <div className="flex p-1 bg-claude-panel rounded-lg text-[13px]">
            <button
              className={`flex-1 py-1.5 rounded-md transition-colors ${
                mode === 'login'
                  ? 'bg-white text-claude-text shadow-soft font-medium'
          ...
          <div className="space-y-2">
            ...
            <input
              className="w-full border border-claude-border rounded-lg px-3 py-2 text-sm bg-white focus:outline-none focus:border-claude-orange focus:ring-2 focus:ring-claude-orange/20 transition-shadow"
              value={username}
